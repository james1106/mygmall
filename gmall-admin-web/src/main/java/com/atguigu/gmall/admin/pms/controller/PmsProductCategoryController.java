...
public class PmsProductCategoryController {
    ...
    public Object create(@Validated @RequestBody PmsProductCategoryParam productCategoryParam,
        ...
        productCategoryService.saveProductCategory(productCategoryParam);
    ...
    public Object getList(@PathVariable Long parentId,
        ...
        PageInfoVo pageInfoVo = productCategoryService.getPageInfoByCondition(parentId,pageNum,pageSize);
    ...
    public Object listWithChildren() {
        //TODO 查询所有一级分类及子分类
        List<PmsProductCategoryWithChildrenItem> items = productCategoryService.getProductCategoryWithChildren(0);

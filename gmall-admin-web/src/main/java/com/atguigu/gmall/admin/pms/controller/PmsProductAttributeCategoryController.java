...
public class PmsProductAttributeCategoryController {
    ...
    public Object create(@RequestParam String name) {
        productAttributeCategoryService.saveProductAttributeCategory(name);
    ...
    public Object getListWithAttr() {
        List<PmsProductAttributeCategoryItem> list = productAttributeCategoryService.getPmsProductAttributeCategoryItemList();
